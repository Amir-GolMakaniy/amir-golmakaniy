<flux:footer container class="shadow-2xl bg-zinc-200 dark:bg-zinc-900">
    <section id="phone" class="flex flex-col md:flex-row justify-between items-center space-y-4">
        <span class="text-2xl truncate font-semibold">امیر گلمکانی</span>
...
" class="bi bi-linkedin" viewBox="0 0 16 16">
    ...
    <div x-data="{ showButton: false }" @scroll.window="showButton = (window.pageYOffset > 300)" class="relative">
        <button x-show="showButton" x-transition
                @click="window.scrollTo({ top: 0, behavior: 'smooth' })"
                class="hidden md:flex cursor-pointer fixed bottom-10 right-20 bg-zinc-800 dark:bg-zinc-100 text-white dark:text-black p-3 rounded-full shadow-md hover:bg-zinc-500 duration-300">
            <flux:icon.arrow-up/>
        </button>
    </div>
</flux:footer>