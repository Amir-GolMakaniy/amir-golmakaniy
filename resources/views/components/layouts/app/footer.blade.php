...
<footer>
    <div class="container">
        <div class="footer-inner">
            <a href="#" class="footer-logo" style="font-size: 3rem">امیر گلمکانی</a>
            ...
            <div class="footer-bottom d-flex">
                <p class="copyright">امیر گلمکانی</p>
                <div class="footer-social">
                    <a href="t.me/Amir_Golmakaniy">
                        <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="#0088cc"
                    ...
                    <a href="https://instagram.com/Amir_Golmakaniy">
                        <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="#E4405F
" class="bi bi-instagram" viewBox="0 0 16 16">
                    ...
                    <a href="https://github.com/Amir-Golmakaniy">
                        <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="#181717
" class="bi bi-github" viewBox="0 0 16 16">
                    ...
                    <a href="https://www.linkedin.com/in/amir-golmakaniy">
                        <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="#0077B5
...
<div class="modal-container">
    <div class="modal">
        <div class="modal-image">
            <img src="{{ asset('images/projects/1.png') }}" alt="image">
        </div>
        <div class="modal-content">

            <h3>مدیریت باشگاه فوتبال رشد</h3>
            <p class="requirments">
                مدیریت مشتریان و حضور غیاب مشتریان و کنترل شهریه و لباس ها
            </p>

            <ul>
                <li><span>مهارت ها:-</span> HTML, CSS, BOOTSTRAP 5, JAVASCRIPT, LARAVEL, LIVEWIRE</li>
...
<a href="javascript:void(0)" class="scrollup">
    <img src="{{ asset('images/uparrow.svg') }}" alt="arrow up">
</a>
</body>
