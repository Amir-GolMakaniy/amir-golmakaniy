...
" class="bi bi-linkedin" viewBox="0 0 16 16">
    ...
    <div x-data="{ showButton: false }" @scroll.window="showButton = (window.pageYOffset > 300)" class="relative">
        <button x-show="showButton" x-transition
                ...
                class="cursor-pointer fixed bottom-10 right-20 bg-zinc-800 dark:bg-zinc-100 text-white dark:text-black p-3 rounded-full shadow-md hover:bg-zinc-500 duration-300">
            <flux:icon.arrow-up/>
        </button>
    </div>
</flux:footer>