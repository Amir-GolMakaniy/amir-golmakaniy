...
@php
    ...
    $classes = Flux::classes()
        ...
        ->add($square ? '' : 'px-2.5!')
        ->add('dark:text-white/80 dark:text-white/80 ')
...
<flux:button-or-link :attributes="$attributes->class($classes)" data-flux-navbar-items>
    ...
    <div class="{{ $icon ? 'ms-3' : '' }} flex-1 text-sm font-medium leading-none whitespace-nowrap [[data-nav-footer]_&]:hidden [[data-nav-sidebar]_[data-nav-footer]_&]:block"
